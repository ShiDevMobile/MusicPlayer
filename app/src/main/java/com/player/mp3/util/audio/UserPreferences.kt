package com.player.mp3.util.audio
...
class UserPreferences @Inject constructor (@ApplicationContext val context: Context){
    companion object {
        private const val MP3_PLAYER_PREFERENCES ="mp3Player"
        private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(
            MP3_PLAYER_PREFERENCES
      )
        private val FAVORITE_SONGS_KEY = stringPreferencesKey(
            "FAVORITE_SONGS"
        )
    }
